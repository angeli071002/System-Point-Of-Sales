          ...
          <section class="wrapper">
              ...
              <div class="row">
                  <div class="col-lg-12 main-chart">
						<h3>
							<!--<a  style="padding-left:2pc;" href="fungsi/hapus/hapus.php?laporanbeli=beli" onclick="javascript:return confirm('Data laporan pembelian akan di Hapus ?');">
						...
						<form method="post" action="index.php?page=laporanbeli&cari=ok">
							<table class="table table-striped">
								...
								<td>
									...
									<?php if(!empty($_GET['cari'])){?>
										<a href="excel_pembelian.php?cari=yes&bln=<?=$_POST['bln'];?>&thn=<?=$_POST['thn'];?>" class="btn btn-info"><i class="fa fa-download"></i>
										Excel</a>
									<?php }else{?>
										<a href="excel_pembelian.php" class="btn btn-info"><i class="fa fa-download"></i>
										Excel</a>
									<?php }?>
								</td>
								</tr>
							...
							<table class="table table-striped">
								...
								<td>
									...
									<?php if(!empty($_GET['hari'])){?>
										<a href="excel_pembelian.php?hari=cek&tgl=<?= $_POST['hari'];?>" class="btn btn-info"><i class="fa fa-download"></i>
										Excel</a>
									<?php }else{?>
										<a href="excel_pembelian.php" class="btn btn-info"><i class="fa fa-download"></i>
										Excel</a>
