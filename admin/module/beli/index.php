								...
								<div class="panel-body">
									...
									<div id="kasirnya">
										<table class="table table-stripped">
											<?php
											// proses bayar dan ke nota_beli
											if(!empty($_GET['nota_beli'] == 'yes')) {
												$total = $_POST['total'];
												$bayar = $_POST['bayar'];
												if(!empty($bayar))
												{
													...
													if($bayar >= $total)
													{
														...
														for($x=0;$x<$jumlah_dipilih;$x++){
															...
															$sql = "INSERT INTO nota_beli (id_barang,id_member,jumlah,total,tanggal_input,periode) VALUES(?,?,?,?,?,?)";
											...
											?>
											<!-- aksi ke table nota_beli -->
											<form method="POST" action="index.php?page=beli&nota_beli=yes#kasirnya">
												<?php foreach($hasil_pembelian as $isi){;?>
												...
												<tr>
 												...
 												<td><button class="btn btn-success"><i class="fa fa-shopping-cart"></i> Bayar</button>
 													<?php if (isset($_GET['nota_beli'])) { ?>
 														<?php if (!empty($_GET['nota_beli'] == 'yes')) { ?>
											...
											<tr>
												...
												<td></td>
												<td>
													<a href="print_pembelian.php?nm_member=<?php echo $_SESSION['admin']['nm_member'];?>
